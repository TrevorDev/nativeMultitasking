...
VkExtent2D chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities, AppWindow* window) {
...
// Initialize vulkan --------------------------------------------------------------------------------------------------------------------------
	...
	// Create surface
	VkSurfaceKHR surface = appWindow->createSurface(instance);
	...
	VkExtent2D extent = chooseSwapExtent(swapChainSupport.capabilities, appWindow);
